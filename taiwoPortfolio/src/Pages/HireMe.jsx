...
const HireMe = () => {
  ...
  return (
    <div className="w-full mt-6 mb-40 font-bodyFont">
      <div className="flex">
        <div className="w-[650px] h-96 ml-44 text-white">
          <h1 className="text-orange-600 font-bold text-[40px]">Hire Me</h1>
          ...
          <div>
            ...
            <button
              className="w-full bg-orange-600 my-4 text-white p-2"
